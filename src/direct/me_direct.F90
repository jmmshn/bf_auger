...
#endif
#if defined (GAN4) || defined (ALN4)
    n_val = real(2*3 + 2*5,dp)/Vcell !GaN AlN
#endif
#if defined (GAN8) || defined (ALN8) || defined (ALGAN8)
    n_val = real(4*3 + 4*5,dp)/Vcell !GaN AlN
#endif
...
#endif
#ifdef INAS
    real(dp), parameter :: epsilon_0 = 12.3_dp
#endif
#ifdef INP
    real(dp), parameter :: epsilon_0 = 9.61_dp
#endif
#if defined (GAN4) || defined (GAN8) || defined (ALGAN8)
    real(dp), parameter :: epsilon_0 = 5.35_dp !GaN
#endif
#if defined (ALN4) || defined (ALN8)
    real(dp), parameter :: epsilon_0 = 4.68_dp !AlN
#endif
